...
class STSSL(nn.Module):
    def __init__(self, args):
        ...
        self.mae = masked_mae(mask_value=5.0)
        self.args = args
    
    def forward(self, view1, graph):
        # print(view1.shape) #32,19,128,2
        repr1 = self.encoder(view1, graph) # view1: n,l,v,c; graph: v,v 
        # print(repr1.shape) #32,1,128,64
        s_sim_mx = self.fetch_spatial_sim() # encoder

        graph2 = aug_topology(s_sim_mx, graph, percent=self.args.percent*2)
        
        t_sim_mx = self.fetch_temporal_sim() # encoder 19,32,128
